...
// Ejercicio 12v1a - Mostrar el cubo de los primeros n números naturales

public class Ejercicio12v1b {

    public static void main(String[] args) {
        int num,n; // Definimos la variable entera 'num'
        num=1; // Inicializamos 'num' con el primer número natural
        
        // Pedimos de cuántos de los primeros naturales mostrar el cubo ('n')
        ...
        // Mientras 'num' sea menor que n+1 calculamos su cubo
        while (num<(n+1)){
