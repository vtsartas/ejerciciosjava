...
// librerías necesarias para usar el método BufferRead para la entrada de datos por consola
...
public class CondicionalesBufferRead {
    ...
    // se añade "throws IOException" al método 'main()' por si hay errores de excepción al leer con BufferRead
    public static void main(String[] args) throws IOException {
        //Notar que readLine() nos obliga a declarar IOException
        BufferedReader valor = new BufferedReader(new InputStreamReader(System.in)); // instanciamos un objeto de la clase para leer
        String otra;
        int nota,dia;
        // condición simple
        ...
        do{
            ...
            nota = Integer.parseInt(valor.readLine());//Se transforma la entrada anterior en un entero
            ...
            otra=valor.readLine(); //Se lee el nombre con readLine() que retorna un String con el dato;
        } while (otra.equals("s"));
        ...
        do{
            ...
            nota = Integer.parseInt(valor.readLine());
            if (nota>=5){
                System.out.println("Aprobado");
            }
            else{
        ...
        do{
            ...
            dia = Integer.parseInt(valor.readLine());
        ...
        do{
            ...
            horausuario=Integer.parseInt(valor.readLine());
